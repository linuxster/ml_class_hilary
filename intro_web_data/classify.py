...
#Hack notes:
#Stemming and Synonym sets may improve performance for your needs.
#wordnet and wordnik can be used to bootstrap a larger, more descriptive feature set for text data.
...
class NaiveBayesClassifier(object):
    ...
    def get_features(self, document):
        ...
        all_words = [w for w in word_tokenize(document) if len(w) > 3 and len(w) < 16] #removes words with less than or greater than a certain number of characters.
        p = PorterStemmer() #uses the Porter stemming algorithm. NLTK has implementation like C.
...
if __name__ == '__main__':
    ...
    data = {} #create dictionary to hold the data
    for label in labels:
        f = open(label, 'r')
